...
- [X] Создание полного дизайна в Figma
- [ ] Реализация полноценного дизайна для программы
...
- [X] Настройки окна (Динамическое изменение разрешения из UI)
- [ ] Локализация системных ошибок (Перевод Rust OS ошибок в человекочитаемый вид)
- [X] Проверка процессов (Блокировка кнопок, если .exe игры запущен)
- [X] Обработка нехватки места на диске (Предупреждение перед скачиванием/распаковкой)
- [ ] Кнопка "Ссылка не работает" (Жалоба на нерабочий primary_url)
- [X] Автопоиск игр (Парсинг Steam/Epic реестров)
...
## ... ну и самое главное ...
- [X] Принятие того, через что придётся пройти...
- [ ] Реализовать API для полноценной работы над проектом